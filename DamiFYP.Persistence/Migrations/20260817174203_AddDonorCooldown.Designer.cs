...
namespace DamiFYP.Persistence.Migrations
{
    ...
    [Migration("20260817174203_AddDonorCooldown")]
    partial class AddDonorCooldown
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DamiFYP.Domain.Models.BotMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DamiUserId", "SentAt");

                    b.ToTable("BotMessage", (string)null);
                });
            ...
            modelBuilder.Entity("DamiFYP.Domain.Models.DamiBadge", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DamiBadge", (string)null);
                });
            ...
            modelBuilder.Entity("DamiFYP.Domain.Models.DonorFeedback", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DonorFeedback", (string)null);
                });
            ...
            modelBuilder.Entity("DamiFYP.Domain.Models.DamiBadge", b =>
                {
                    b.HasOne("DamiFYP.Domain.Models.DamiUser", "DamiUser")
                        .WithOne("DamiBadge")
                        .HasForeignKey("DamiFYP.Domain.Models.DamiBadge", "DamiUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DamiFYP.Domain.Models.DonorFeedback", b =>
                {
                    b.HasOne("DamiFYP.Domain.Models.DonationRequest", "DonationRequest")
                        .WithOne("DonorFeedback")
                        .HasForeignKey("DamiFYP.Domain.Models.DonorFeedback", "DonationRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
